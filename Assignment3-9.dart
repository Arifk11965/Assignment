// Q.9	Write a program that takes a list of student details as input,
// where each student is represented by a map containing their name, marks,
// section, and roll number. The program should determine the grade of each
// student based on their average score (assuming maximum marks for each
// subject is 100) and print the student's name along with their grade.
// 
// List<Map> student Details = [
